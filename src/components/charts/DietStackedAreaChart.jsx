...
function DietStackedAreaChart({ activeStep }) {
  ...
  useEffect(() => {
    ...
    const data = activeStep === 0 ? dietStructureData.slice(0, 3) : dietStructureData;
    ...
    svg
      ...
      .attr('x', x(2000))
      .attr('y', y(72))
      .text(activeStep === 0 ? '餐桌先从主食中心出发' : '谷物占比下降，多样化食品上升');
  }, [activeStep]);

  return <svg ref={svgRef} className="chart-card" />;
}

export default DietStackedAreaChart;
